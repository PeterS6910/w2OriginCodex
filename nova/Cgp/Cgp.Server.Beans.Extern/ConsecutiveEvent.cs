...
namespace Contal.Cgp.Server.Beans.Extern
{
    ...
    /// </summary>
    [Serializable]
    public class ConsecutiveEvent: AOrmObject
    {
        ...
        public ConsecutiveEvent(long lastEventId,string type, Guid sourceId, Guid reasonId, DateTime eventDateTime)
        {
            Id = 0; //not registred in db
            LastEventLogId = lastEventId;
            SourceId= sourceId;
            ReasonId = reasonId;
            AccessDeniedType = IsAccessDeniedTypeMultiple(type);
            EventDateTime = eventDateTime;
        }
        public ConsecutiveEvent(long id, long lastEventId, Guid sourceId, Guid reasonId)
        {
            Id = id;
            LastEventLogId = lastEventId;
            SourceId = sourceId;
        ...
        public ConsecutiveEvent(long id,  Guid sourceId, Guid reasonId, DateTime eventDateTime)
        {
            Id = id;
            LastEventLogId = null;
            SourceId = sourceId;
        ...
        public override bool Compare(object obj)
        {
            ...
            return obj is ConsecutiveEvent && (obj as ConsecutiveEvent).Id == Id;
        }
