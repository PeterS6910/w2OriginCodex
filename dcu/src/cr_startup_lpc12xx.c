...
void PIO0_IRQHandler (void) ALIAS(IntDefaultHandler);
void PIO1_IRQHandler (void) ALIAS(IntDefaultHandler);
void PIO2_IRQHandler (void) ALIAS(IntDefaultHandler);
...
/* APP CRC - NOT USED because it is inserted by external app */
//__attribute__ ((section(".crc"))) uint8_t reserverForCRC[8];
...
void (* const g_pfnVectors[])(void) = {
    ...
    WAKEUP_IRQHandler,
    I2C_IRQHandler,            // I2C
    CT16B1_IRQHandler,      // 16-bit Timer0
    CT16B0_IRQHandler,      // 16-bit Timer1
    CT32B0_IRQHandler,      // 32-bit Timer0
    CT32B1_IRQHandler,      // 32-bit Timer1
    SSP0_IRQHandler,            // SSP
    UART0_IRQHandler,          // UART0
    UART1_IRQHandler,          // UART1
    CMP_IRQHandler,           // Comparators 0,1
    ADC_IRQHandler,            // A/D Converter
    WDT_IRQHandler,            // Watchdog timer
    BOD_IRQHandler,            // Brown Out Detect
    FLASH_IRQHandler,            			   // Reserved
    PIO0_IRQHandler,        // PIO INT0
    PIO1_IRQHandler,        // PIO INT1
    PIO2_IRQHandler,        // PIO INT2
    PMU_IRQHandler,            			   // Reserved
    DMA_IRQHandler,            // DMA
    RTC_IRQHandler,            // RTC
};
