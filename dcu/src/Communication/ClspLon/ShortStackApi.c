...
const LonApiError LonInit(void)
{
    ...
    if (result == LonApiNoError)
    {
        ...
        LonSmipMsg* pMsg = &smipMsg;
        
        result = LdvPutMsgBlocking(pMsg);
    }
                            ...
                            else if (CurrentNmNdStatus == ND_PENDING)
                            {
                                ...
                                switch ((EXPMSG.Code & LON_ND_OPCODE_MASK) | LON_ND_OPCODE_BASE)
                                {
                                    ...
                                    case LonNdQueryXcvr:
                                        ...
                                        LonTransceiverStatusReceived((const LonTransceiverParameters*)&(EXPMSG.Data.QueryXcvrStatusResponse.Status), (LonBool)(EXPMSG.Code == LON_NM_SUCCESS(LonNdQueryXcvr)));
                                        break;
                                    default:
                                        break;
                                }
